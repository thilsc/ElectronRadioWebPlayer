...
async function populate() {
    ...
    const requestURL = 'https://thilsc.github.io/RadioWebPlayer/stations.json';
...
// Listener para reproduzir a estação selecionada
ipcRenderer.on('play-station', (event, stationSrc) => {
